...
namespace UI
{
    public partial class AnaSayfa : Form
    {
        ...
        {
            //Sefer seçimi var mı sefer yok mu kontrol...!!!!
        ...
        private Kullanici GenerateKullanici(int i)
        {
            ...
            _uow.SaveChanges();
            kullanici = _kullaniciRepository.Get(p => p.CitizienshipNumber == citizienshipNumber.Text); //HATA AYNI TC KİMLİK NUMARASIYLA KAYIT ALMIYOR
            return kullanici;
        }
        ...
        private void lblKoltukNumarasi2_Click(object sender, EventArgs e)
        {

        }

        private void lblBiletFiyati2_Click(object sender, EventArgs e)
        {
